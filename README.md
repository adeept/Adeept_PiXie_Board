# Adeept_PiXie_Board
The Adeept PiXie Board is an Arduino‑based robot control board. The tutorials include numerous sensor examples, allowing enthusiasts to build their own robots with it.
